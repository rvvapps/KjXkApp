    ...
    sections: [
      {
        ...
        text: "Caja Chica te permite registrar tus gastos y agruparlos en rendiciones para solicitar reembolso. Todo queda guardado localmente en tu dispositivo.",
      },
      {
  ...
  "/ajustes": {
    ...
    sections: [
      ...
      },
      {
        ...
        text: "• Prefijo y número correlativo de rendiciones (ej: RC-001)\n• CR por defecto: se pre-selecciona al crear un gasto\n• Origen por defecto: punto de partida habitual para trayectos\n• Nombre del dispositivo: identifica este equipo",
      },
      {
        heading: "Pestaña Datos — Backup",
        text: "Genera un archivo .cczip con todos tus datos protegido por contraseña. Guárdalo en un lugar seguro. Recomendado hacer backup antes de restaurar.",
      },
      {
        heading: "Pestaña Datos — Restaurar",
        text: "Permite recuperar datos desde un archivo .cczip descargado antes. La restauración reemplaza todos los datos actuales.",
      },
      {
        heading: "Pestaña Datos — Borrar datos",
        text: "Elimina todos los datos locales de la app (gastos, rendiciones, traslados, catálogos). Acción irreversible — haz un backup antes.",
      },
    ],
  },
};
